    ...
    <div className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 relative overflow-hidden">
      <div className="  px-4 pt-24 lg:pt-40 sm:px-6 lg:flex-none lg:px-20 xl:px-24 flex flex-col border-l border-border overflow-hidden bg-muted">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="flex items-center gap-2 flex-row bg-card shadow-sm rounded-lg p-2 hover:bg-accent/80 transition-colors w-72"
                >
                  <StrapiImage
                  ...
                  <div className="text-xs text-foreground flex flex-col gap-1">
                    <div>{item.link[0]?.text}</div>
                    <div>{item.link[0]?.info}</div>
                  </div>
                </Link>
              </li>
            );
        ...
        <div className="flex-1 flex items-center justify-center absolute bottom-0">
          <Image
            src={`/${siteId}/logo-white.png`}
            alt="Logo"
            width={700}
            height={700}
            className="opacity-10 hidden dark:block"
          />
          <Image
            src={`/${siteId}/logo-black.png`}
            alt="Logo"
            width={700}
            height={700}
